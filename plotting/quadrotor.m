...
h(11) = surface([xlocation4+xprop],...
                ...
                'faceColor',propColor,'linestyle',linestyle,'edgeColor',propColor);
propFactor = 1;
% This code below fills in the rotor section of each quadcopter
h(12) = fill3(xlocation1+xprop(1,:)*propFactor,ylocation1+yprop(1,:)*propFactor,z+zprop(1,:)+propHeight,propColor, 'FaceAlpha',0.3);
h(13) = fill3(xlocation1+xprop(1,:)*propFactor,ylocation1+yprop(1,:)*propFactor,z+zprop(1,:),propColor,'FaceAlpha',0.3);
h(14) = fill3(xlocation2+xprop(1,:)*propFactor,ylocation2+yprop(1,:)*propFactor,z+zprop(1,:)+propHeight,propColor,'FaceAlpha',0.3);
h(15) = fill3(xlocation2+xprop(1,:)*propFactor,ylocation2+yprop(1,:)*propFactor,z+zprop(1,:),propColor,'FaceAlpha',0.3);
h(16) = fill3(xlocation3+xprop(1,:)*propFactor,ylocation3+yprop(1,:)*propFactor,z+zprop(1,:)+propHeight,propColor,'FaceAlpha',0.3);
h(17) = fill3(xlocation3+xprop(1,:)*propFactor,ylocation3+yprop(1,:)*propFactor,z+zprop(1,:),propColor,'FaceAlpha',0.3);
h(18) = fill3(xlocation4+xprop(1,:)*propFactor,ylocation4+yprop(1,:)*propFactor,z+zprop(1,:)+propHeight,propColor,'FaceAlpha',0.3);
h(19) = fill3(xlocation4+xprop(1,:)*propFactor,ylocation4+yprop(1,:)*propFactor,z+zprop(1,:),propColor,'FaceAlpha',0.3);
