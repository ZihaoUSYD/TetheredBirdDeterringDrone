...
% body 2
p1 = [x-bodyWidth/w_s, y-bodyWidth/h_s, z] + [0, 2*bodyWidth, 0];
p2 = [x+bodyWidth/w_s, y-bodyWidth/h_s, z] + [0, 2*bodyWidth, 0];
...
% body 4
p1 = [x-bodyWidth/w_s, y-bodyWidth/h_s, z] + [2*bodyWidth, 0, 0];
p2 = [x+bodyWidth/w_s, y-bodyWidth/h_s, z] + [2*bodyWidth, 0, 0];
